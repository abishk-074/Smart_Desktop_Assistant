...
def createFile(text):
    ...
    appLocation = "C:\Program Files\Sublime Text\sublime_text.exe"

    if isContain(text, ["ppt","power point","powerpoint"]):
        file_name= "sample_File_PPT.ppt"
        appLocation = "C:\Program Files\Microsoft Office\Office15\POWERPNT.EXE"

    elif isContain(text, ['excel','spreadsheet','xsl']):
        file_name= "sample_File_EXCEL.xsl"
        appLocation = "C:\Program Files\Microsoft Office\Office15\EXCEL.EXE"

    elif isContain(text, ['word','document','doc','docx']):
        file_name = "sample_File_DOC.docx"
    ...
    elif "c" in text or "c lang" in text: file_name = "sample_file.c"
